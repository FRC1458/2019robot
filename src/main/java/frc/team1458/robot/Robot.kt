...
class Robot : BaseRobot() {
    ...
    val dt: TankDrive = TankDrive(
        leftMaster = SmartMotor.CANtalonSRX(13),
        rightMaster = SmartMotor.CANtalonSRX(27).inverted,
        leftMotors = arrayOf(SmartMotor.CANtalonSRX(26)),
        rightMotors = arrayOf(SmartMotor.CANtalonSRX(15).inverted),
